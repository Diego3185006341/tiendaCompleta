	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("btncon") != null) {
			...
			if (request.getParameter("cedula_cliente") != "") {
				...
				if (recdatos != null) {
					...
					request.setAttribute("mensaje_warning", "No existen datos para el n�mero de c�dula ingresado.");
					request.getRequestDispatcher("Clientes.jsp").forward(request, response);
				}

			} else {
				request.setAttribute("mensaje_warning", "Ingrese un n�mero de c�dula para consultar.");
				request.getRequestDispatcher("Clientes.jsp").forward(request, response);
			}
		...
		if (request.getParameter("btneli") != null) {
			...
			if (request.getParameter("cedula_cliente") != "") {
				...
				request.setAttribute("mensaje_warning", "Ingrese un n�mero de c�dula para eliminar.");
				request.getRequestDispatcher("Clientes.jsp").forward(request, response);
			}
